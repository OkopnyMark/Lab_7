...
namespace bkit_lab7
{
    ...
    class Program
    {
        ...
        {
                new Worker(1,"Васильев",1),
                new Worker(2,"Прудниченков",1),
                new Worker(3,"Окопный",1),
                new Worker(4,"Александров",2),
                new Worker(5,"Кондратьев",2),
                new Worker(6,"Аконный",3),
                new Worker(7,"Фетисов",2),
                new Worker(8,"Миликанец",2),
                new Worker(9,"Белов",1)
        };
