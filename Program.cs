...
namespace bkit_lab7
{
    ...
    class Program
    {
        ...
        {
                new Worker(1,"Окопный",1),
                new Worker(2,"Васильев",1),
                new Worker(3,"Байбарин",1),
                new Worker(4,"Прудниченков",2),
                new Worker(5,"Каримова",2),
                new Worker(6,"Тимаков",3),
                new Worker(7,"Аловьев",2),
                new Worker(8,"Чуков",2),
                new Worker(9,"Румянцев",1)
        };
